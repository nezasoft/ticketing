...
-- Dumping data for table rt_oris.auth_users: ~2 rows (approximately)
...
INSERT INTO `business_docs` (`id`, `company_id`, `document_name`, `document_no`, `document_value`, `doc_code`, `created_at`, `updated_at`) VALUES
	(34, 1, 'Ticket', '1', 5, 'TK', '2025-04-13 15:21:18', '2025-04-26 14:55:36');
...
-- Dumping data for table rt_oris.companies: ~1 rows (approximately)
...
-- Dumping data for table rt_oris.customers: ~1 rows (approximately)
...
INSERT INTO `emails` (`id`, `email`, `name`, `dept_id`, `priority_id`, `company_id`, `help_topic`, `username`, `password`, `fetching_host`, `fetching_port`, `fetching_protocol`, `fetching_encryption`, `mailbox_protocol`, `imap_config`, `folder`, `sending_host`, `sending_port`, `sending_protocol`, `sending_encryption`, `smtp_validate`, `smtp_authentication`, `internal_notes`, `auto_response`, `fetching_status`, `move_to_folder`, `delete_email`, `do_nothing`, `sending_status`, `authentication`, `header_spoofing`, `created_at`, `updated_at`) VALUES
	(1, 'info@nezasoft.net', 'Nezasoft Email', 1, 3, 2, NULL, 'info@nezasoft.net', '#info2016', 'saver.vivawebhost.com', '993', 'imap', 'tls', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL),
	(2, 'support@nezasoft.net', 'Technical Support', 3, 1, 2, NULL, NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL),
	(3, 'customer_care@nezasoft.net', 'Customer Care', 2, 2, 2, NULL, NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL),
	(4, 'demo@nezasoft.net', 'Support Email', 3, 1, 2, NULL, 'demo@nezasoft.net', '#demo2016', 'saver.vivawebhost.com', '466', 'imap', 'ssl', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-19 16:37:03', '2025-05-19 16:37:03');
...
-- Dumping data for table rt_oris.notifications: ~5 rows (approximately)
DELETE FROM `notifications`;
/*!40000 ALTER TABLE `notifications` DISABLE KEYS */;
INSERT INTO `notifications` (`id`, `user_id`, `type_id`, `created_at`, `updated_at`, `company_id`) VALUES
	(1, 1, 3, '2025-04-25 17:07:38', '2025-04-25 17:07:38', NULL),
	(2, 2, 3, '2025-04-25 17:07:38', '2025-04-25 17:07:38', NULL),
	(7, 1, 3, '2025-04-26 14:45:11', '2025-04-26 14:45:11', NULL),
	(8, 1, 3, '2025-04-26 14:46:47', '2025-04-26 14:46:47', NULL),
	(9, 2, 3, '2025-04-26 14:55:36', '2025-04-26 14:55:36', NULL);
...
-- Dumping data for table rt_oris.sessions: ~3 rows (approximately)
...
INSERT INTO `sla_rules` (`id`, `sla_policy_id`, `customer_type_id`, `priority_id`, `channel_id`, `created_at`, `updated_at`, `company_id`) VALUES
	(1, 1, 1, 1, 1, '2025-05-19 17:44:00', '2025-05-19 17:44:00', NULL),
	(2, 1, 1, 1, 1, '2025-05-19 17:45:04', '2025-05-19 17:45:04', 2);
...
INSERT INTO `templates` (`id`, `name`, `variable`, `type`, `subject`, `message`, `description`, `set_id`, `created_at`, `updated_at`) VALUES
	...
	(7, 'This template is for sending notice to client on new registration during new ticket creation for un registered clients', '1', 7, 'Registration Confirmation', '<p>Hello {!!$user!!},Â </p><p>This email is confirmation that you are now registered at our helpdesk.</p><p><b>Registered Email:</b> {!!$email_address!!}</p><p><b>Password:</b> {!!$user_password!!}</p><p>You can visit the helpdesk to browse articles and contact us at any time: {!!$system_link!!}</p><p>Thank You.</p><p>Kind Regards,</p><p> {!!$system_from!!}Â </p>', '', 1, '2016-12-13 06:19:51', '2016-12-13 06:19:51'),
	...
	(9, 'This template is for sending notice to client when a reply made to his/her ticket', '0', 9, '', '<span></span><div><span></span><p> {!!$content!!}<br /></p><p> {!!$agent_sign!!}Â </p><p><b>Ticket Details</b></p><p><b>Ticket ID:</b> {!!$ticket_number!!}</p></div>', '', 1, '2016-12-13 06:19:51', '2016-12-13 06:19:51'),
	...
	(11, 'This template is for sending notice to client about registration confirmation link', '1', 11, 'Verify your email address', '<p>Hello {!!$user!!},Â </p><p>This email is confirmation that you are now registered at our helpdesk.</p><p><b>Registered Email:</b> {!!$email_address!!}</p><p>Please click on the below link to activate your account and Login to the system {!!$password_reset_link!!}</p><p>Thank You.</p><p>Kind Regards,</p><p> {!!$system_from!!}Â </p>', '', 1, '2016-12-13 06:19:52', '2016-12-13 06:19:52'),
	(12, 'This template is for sending notice to team when ticket is assigned to team', '1', 12, '', '<div>Hello {!!$ticket_agent_name!!},<br /><br /><b>Ticket No:</b> {!!$ticket_number!!}<br />Has been assigned to your team : {!!$team!!} by {!!$ticket_assigner!!}Â <br /><br />Thank You<br />Kind Regards,<br />{!!$system_from!!}</div>', '', 1, '2016-12-13 06:19:52', '2016-12-13 06:19:52'),
...
-- Dumping data for table rt_oris.tickets: ~4 rows (approximately)
DELETE FROM `tickets`;
...
INSERT INTO `tickets` (`id`, `ticket_no`, `customer_id`, `priority_id`, `channel_id`, `ticket_type_id`, `subject`, `status_id`, `company_id`, `description`, `first_response_at`, `resolved_at`, `created_at`, `updated_at`) VALUES
	(1, '100000001', 1, 1, 2, 1, '[Internet Service Outage] - 100000001', 1, 1, 'I have been experiencing slow internet speeds for the past one week. Kindly help resolve the issue.', NULL, NULL, '2025-04-25 17:07:33', '2025-04-25 17:07:33'),
	(20, '100000002', 0, 2, 3, 2, '[Another one] - 100000002', 1, 2, 'Another one', NULL, NULL, '2025-04-26 14:45:11', '2025-04-26 14:45:11'),
	(21, '100000003', 0, 2, 3, 2, '[This is a test WhatsApp Channel Message] - 100000003', 1, 2, 'This is a test WhatsApp Channel Message', NULL, NULL, '2025-04-26 14:46:47', '2025-04-26 14:46:47'),
	(23, '100000004', 0, 2, 2, 2, '[This is just a web portal test message] - 100000004', 1, 2, 'This is a web portal test message description', NULL, NULL, '2025-04-26 14:55:36', '2025-04-26 14:55:36');
...
-- Dumping data for table rt_oris.ticket_replies: ~2 rows (approximately)
...
INSERT INTO `ticket_replies` (`id`, `ticket_id`, `user_id`, `reply_message`, `reply_at`, `created_at`, `updated_at`) VALUES
	(1, 1, 0, 'Thank you for reaching out to us. We will assign a technical team to resolve your issue', '2025-04-25 17:12:31', '2025-04-25 17:12:31', '2025-04-25 17:12:31'),
	(6, 21, 1, 'Hello Walter we have received your request. We have sent our team to resolve your issue', '2025-04-26 15:57:32', '2025-04-26 15:57:32', '2025-04-26 15:57:32');
...
-- Dumping data for table rt_oris.twillios: ~1 rows (approximately)
...
-- Dumping data for table rt_oris.whats_apps: ~1 rows (approximately)
