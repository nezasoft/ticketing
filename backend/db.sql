...
INSERT INTO `auth_users` (`id`, `name`, `email`, `company_id`, `password_hash`, `phone`, `dept_id`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'Walter Adamba', 'wadamba@yahoo.com', 1, NULL, '0724802834', 1, 1, '2025-04-13 09:23:03', '2025-04-13 09:23:04'),
	(2, 'John Doe', 'nezasoft@gmail.com', 1, NULL, '0727129606', 3, 1, '2025-04-25 16:25:06', '2025-04-25 16:25:07');
...
INSERT INTO `business_docs` (`id`, `company_id`, `document_name`, `document_no`, `document_value`, `doc_code`, `created_at`, `updated_at`) VALUES
	(34, 1, 'Ticket', '1', 5, 'TK', '2025-04-13 12:21:18', '2025-04-26 11:55:36');
...
INSERT INTO `channel_contacts` (`id`, `channel_id`, `email`, `phone`, `company_id`, `created_at`, `updated_at`) VALUES
	(1, 2, 'walter.omedo@gmail.com', '', 1, '2025-04-25 13:55:27', NULL),
	(20, 2, '', '254724802834', 2, '2025-04-26 11:45:11', NULL);
...
INSERT INTO `departments` (`id`, `name`, `created_at`, `updated_at`, `company_id`) VALUES
	(1, 'Management', '2025-04-11 03:20:13', '2025-04-11 03:20:19', NULL),
	(2, 'Customer Care', '2025-04-11 03:20:14', '2025-04-11 03:20:14', NULL),
	(3, 'Technical Support', '2025-04-11 03:20:37', '2025-04-11 03:20:38', NULL);
...
CREATE TABLE IF NOT EXISTS `emails` (
  ...
  `sending_encryption` varchar(255) NOT NULL,
...
INSERT INTO `notifications` (`id`, `user_id`, `type_id`, `created_at`, `updated_at`, `company_id`) VALUES
	(1, 1, 3, '2025-04-25 14:07:38', '2025-04-25 14:07:38', NULL),
	(2, 2, 3, '2025-04-25 14:07:38', '2025-04-25 14:07:38', NULL),
	(7, 1, 3, '2025-04-26 11:45:11', '2025-04-26 11:45:11', NULL),
	(8, 1, 3, '2025-04-26 11:46:47', '2025-04-26 11:46:47', NULL),
	(9, 2, 3, '2025-04-26 11:55:36', '2025-04-26 11:55:36', NULL);
...
INSERT INTO `templates` (`id`, `name`, `variable`, `type`, `subject`, `message`, `description`, `set_id`, `created_at`, `updated_at`) VALUES
	...
	(9, 'This template is for sending notice to client when a reply made to his/her ticket', '0', 9, '', '<span></span><div><span></span><p> {!!$content!!}<br /></p><p> {!!$agent_sign!!}Â </p><p><b>Ticket Details</b></p><p><b>Ticket ID:</b> {!!$ticket_number!!}</p></div>', '', 1, '2016-12-13 03:19:51', '2016-12-13 03:19:51'),
	...
	(12, 'This template is for sending notice to team when ticket is assigned to team', '1', 12, '', '<div>Hello {!!$ticket_agent_name!!},<br /><br /><b>Ticket No:</b> {!!$ticket_number!!}<br />Has been assigned to your team : {!!$team!!} by {!!$ticket_assigner!!}Â <br /><br />Thank You<br />Kind Regards,<br />{!!$system_from!!}</div>', '', 1, '2016-12-13 03:19:52', '2016-12-13 03:19:52'),
...
INSERT INTO `tickets` (`id`, `ticket_no`, `customer_id`, `priority_id`, `channel_id`, `ticket_type_id`, `subject`, `status_id`, `company_id`, `description`, `first_response_at`, `resolved_at`, `created_at`, `updated_at`) VALUES
	(1, '100000001', 1, 1, 2, 1, '[Internet Service Outage] - 100000001', 1, 1, 'I have been experiencing slow internet speeds for the past one week. Kindly help resolve the issue.', NULL, NULL, '2025-04-25 14:07:33', '2025-04-25 14:07:33'),
	(20, '100000002', 0, 2, 3, 2, '[Another one] - 100000002', 1, 2, 'Another one', NULL, NULL, '2025-04-26 11:45:11', '2025-04-26 11:45:11'),
	(21, '100000003', 0, 2, 3, 2, '[This is a test WhatsApp Channel Message] - 100000003', 1, 2, 'This is a test WhatsApp Channel Message', NULL, NULL, '2025-04-26 11:46:47', '2025-04-26 11:46:47'),
	(23, '100000004', 0, 2, 2, 2, '[This is just a web portal test message] - 100000004', 1, 2, 'This is a web portal test message description', NULL, NULL, '2025-04-26 11:55:36', '2025-04-26 11:55:36');
...
INSERT INTO `ticket_replies` (`id`, `ticket_id`, `user_id`, `reply_message`, `reply_at`, `created_at`, `updated_at`) VALUES
	(1, 1, 0, 'Thank you for reaching out to us. We will assign a technical team to resolve your issue', '2025-04-25 17:12:31', '2025-04-25 14:12:31', '2025-04-25 14:12:31'),
	(6, 21, 1, 'Hello Walter we have received your request. We have sent our team to resolve your issue', '2025-04-26 15:57:32', '2025-04-26 12:57:32', '2025-04-26 12:57:32');
