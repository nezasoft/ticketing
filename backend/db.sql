...
INSERT INTO `auth_users` (`id`, `name`, `email`, `company_id`, `password_hash`, `phone`, `dept_id`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'Walter Adamba', 'wadamba@yahoo.com', 2, _binary 0x24327924313224442f4f784a4162425853557a555842456f504a6c6f2e54767a484f5561566c627239752e735258514a4536506c46592f7a5a344857, '0724802834', 1, 1, '2025-04-13 09:23:03', '2025-05-19 13:15:59'),
	(2, 'John Doe', 'nezasoft@gmail.com', 1, NULL, '0727129606', 3, 1, '2025-04-25 16:25:06', '2025-04-25 16:25:07'),
	(3, 'System', 'admin@nezasoft.net', 0, NULL, NULL, 0, 1, '2025-05-23 13:21:54', '2025-05-23 13:22:02');
...
INSERT INTO `business_docs` (`id`, `company_id`, `document_name`, `document_no`, `document_value`, `doc_code`, `created_at`, `updated_at`) VALUES
	(34, 1, 'Ticket', '1', 6, 'TK', '2025-04-13 12:21:18', '2025-07-01 14:03:11');
...
INSERT INTO `emails` (`id`, `email`, `name`, `dept_id`, `priority_id`, `company_id`, `help_topic`, `username`, `password`, `fetching_host`, `fetching_port`, `fetching_protocol`, `fetching_encryption`, `mailbox_protocol`, `imap_config`, `folder`, `sending_host`, `sending_port`, `sending_protocol`, `sending_encryption`, `smtp_validate`, `smtp_authentication`, `internal_notes`, `auto_response`, `fetching_status`, `move_to_folder`, `delete_email`, `do_nothing`, `sending_status`, `authentication`, `header_spoofing`, `created_at`, `updated_at`, `active`) VALUES
	...
	(4, 'demo@nezasoft.net', 'Support Email', 3, 1, 2, NULL, 'demo@nezasoft.net', '#demo2016', 'saver.vivawebhost.com', '466', 'imap', 'ssl', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-19 13:37:03', '2025-05-19 13:37:03', 0);
...
-- Dumping data for table rt_oris.sessions: ~10 rows (approximately)
...
-- Dumping data for table rt_oris.sla_events: ~10 rows (approximately)
...
-- Dumping data for table rt_oris.tickets: ~6 rows (approximately)
DELETE FROM `tickets`;
INSERT INTO `tickets` (`id`, `ticket_no`, `customer_id`, `priority_id`, `channel_id`, `ticket_type_id`, `subject`, `status_id`, `company_id`, `dept_id`, `description`, `first_response_at`, `resolved_at`, `created_at`, `updated_at`, `sla_policy_id`, `sla_duration`, `escalated_at`, `phone`, `email`) VALUES
	(1, '100000001', 1, 1, 2, 1, '[This is the initial test for the mail channel] - 100000001', 3, 2, 3, 'Dear support i have been having issues with my internet connection for the last 3 days. Kindly resolve.', '2025-05-23 12:18:20', NULL, '2025-05-23 09:15:49', '2025-06-01 12:52:56', NULL, NULL, NULL, NULL, 'walter.omedo@gmail.com'),
	(2, '100000002', 0, 2, 3, 2, '[Good Morning, I am having a problem with my internet connection. Please look into it] - 100000002', 3, 2, 1, 'Good Morning, I am having a problem with my internet connection. Please look into it', '2025-05-24 05:18:59', NULL, '2025-05-24 02:16:10', '2025-05-24 02:18:59', NULL, NULL, NULL, NULL, NULL),
	(3, '100000003', 1, 1, 1, 2, '[Test Web Portal Ticket] - 100000003', 1, 2, 1, 'Test web Portal Ticket Description', NULL, NULL, '2025-05-31 04:57:48', '2025-05-31 04:57:48', NULL, NULL, NULL, NULL, NULL),
	(4, '100000004', 1, 1, 1, 2, 'Test Web Portal Ticket- [100000004]', 1, 2, 1, 'Test web Portal Ticket Description', NULL, NULL, '2025-07-01 04:04:32', '2025-07-01 04:04:32', NULL, NULL, NULL, '254724802834', 'omedo.walter@eclectics.io'),
	(6, '100000005', 1, 1, 2, 1, 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.- [100000005]', 3, 2, 1, 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc,', '2025-07-01 17:08:06', NULL, '2025-07-01 14:03:11', '2025-07-01 14:08:06', NULL, NULL, NULL, '', 'walter.omedo@gmail.com');
...
-- Dumping data for table rt_oris.ticket_replies: ~11 rows (approximately)
