...
INSERT INTO `auth_users` (`id`, `name`, `email`, `company_id`, `password_hash`, `phone`, `dept_id`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'Walter Adamba', 'wadamba@yahoo.com', 1, _binary 0x24327924313224442f4f784a4162425853557a555842456f504a6c6f2e54767a484f5561566c627239752e735258514a4536506c46592f7a5a344857, '0724802834', 1, 1, '2025-04-13 09:23:03', '2025-05-19 13:15:59'),
...
INSERT INTO `business_docs` (`id`, `company_id`, `document_name`, `document_no`, `document_value`, `doc_code`, `created_at`, `updated_at`) VALUES
	(34, 1, 'Ticket', '1', 3, 'TK', '2025-04-13 12:21:18', '2025-05-24 02:16:10');
...
-- Dumping data for table rt_oris.department_heads: ~1 rows (approximately)
...
INSERT INTO `emails` (`id`, `email`, `name`, `dept_id`, `priority_id`, `company_id`, `help_topic`, `username`, `password`, `fetching_host`, `fetching_port`, `fetching_protocol`, `fetching_encryption`, `mailbox_protocol`, `imap_config`, `folder`, `sending_host`, `sending_port`, `sending_protocol`, `sending_encryption`, `smtp_validate`, `smtp_authentication`, `internal_notes`, `auto_response`, `fetching_status`, `move_to_folder`, `delete_email`, `do_nothing`, `sending_status`, `authentication`, `header_spoofing`, `created_at`, `updated_at`, `active`) VALUES
	...
	(2, 'support@nezasoft.net', 'Technical Support', 3, 1, 2, NULL, NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, 0),
...
-- Dumping data for table rt_oris.event_types: ~8 rows (approximately)
...
-- Dumping data for table rt_oris.notifications: ~1 rows (approximately)
DELETE FROM `notifications`;
INSERT INTO `notifications` (`id`, `user_id`, `type_id`, `created_at`, `updated_at`, `company_id`) VALUES
	(1, 1, 3, '2025-05-24 02:16:10', '2025-05-24 02:16:10', NULL);
...
-- Dumping data for table rt_oris.sessions: ~5 rows (approximately)
...
-- Dumping data for table rt_oris.sla_events: ~4 rows (approximately)
...
INSERT INTO `templates` (`id`, `name`, `variable`, `type`, `subject`, `message`, `description`, `set_id`, `created_at`, `updated_at`) VALUES
	...
	(9, 'This template is for sending notice to client when a reply made to his/her ticket', '0', 9, '', '<span></span><div><span></span><p> {!!$content!!}<br /></p><p> {!!$agent_sign!!}Ã‚Â </p><p><b>Ticket Details</b></p><p><b>Ticket ID:</b> {!!$ticket_number!!}</p></div>', '', 1, '2016-12-13 03:19:51', '2016-12-13 03:19:51'),
...
DELETE FROM `tickets`;
INSERT INTO `tickets` (`id`, `ticket_no`, `customer_id`, `priority_id`, `channel_id`, `ticket_type_id`, `subject`, `status_id`, `company_id`, `dept_id`, `description`, `first_response_at`, `resolved_at`, `created_at`, `updated_at`, `sla_policy_id`, `sla_duration`, `escalated_at`) VALUES
	(1, '100000001', 1, 1, 2, 1, '[This is the initial test for the mail channel] - 100000001', 3, 2, 0, 'Dear support i have been having issues with my internet connection for the last 3 days. Kindly resolve.', '2025-05-23 12:18:20', NULL, '2025-05-23 09:15:49', '2025-05-23 09:18:20', NULL, NULL, NULL),
	(2, '100000002', 0, 2, 3, 2, '[Good Morning, I am having a problem with my internet connection. Please look into it] - 100000002', 3, 2, 1, 'Good Morning, I am having a problem with my internet connection. Please look into it', '2025-05-24 05:18:59', NULL, '2025-05-24 02:16:10', '2025-05-24 02:18:59', NULL, NULL, NULL);
...
INSERT INTO `ticket_replies` (`id`, `ticket_id`, `user_id`, `reply_message`, `reply_at`, `created_at`, `updated_at`) VALUES
	(1, 1, 0, 'Hello thank for your email. we have looked into your issue. Kindly reboot your router and tell us if your experience has improved.', '2025-05-23 12:18:20', '2025-05-23 09:18:20', '2025-05-23 09:18:20'),
