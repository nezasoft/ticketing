...
INSERT INTO `auth_users` (`id`, `name`, `email`, `company_id`, `password_hash`, `phone`, `dept_id`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'Walter Adamba', 'wadamba@yahoo.com', 1, _binary 0x24327924313224442F4F784A4162425853557A555842456F504A6C6F2E54767A484F5561566C627239752E735258514A4536506C46592F7A5A344857, '0724802834', 1, 1, '2025-04-13 12:23:03', '2025-05-19 16:15:59'),
	(2, 'John Doe', 'nezasoft@gmail.com', 1, NULL, '0727129606', 3, 1, '2025-04-25 19:25:06', '2025-04-25 19:25:07'),
	(3, 'System', 'admin@nezasoft.net', 0, NULL, NULL, 0, 1, '2025-05-23 16:21:54', '2025-05-23 16:22:02');
...
INSERT INTO `business_docs` (`id`, `company_id`, `document_name`, `document_no`, `document_value`, `doc_code`, `created_at`, `updated_at`) VALUES
	(34, 1, 'Ticket', '1', 4, 'TK', '2025-04-13 15:21:18', '2025-05-31 07:57:48');
...
-- Dumping data for table rt_oris.channel_contacts: ~2 rows (approximately)
...
INSERT INTO `channel_contacts` (`id`, `channel_id`, `email`, `phone`, `company_id`, `created_at`, `updated_at`) VALUES
	(1, 2, 'walter.omedo@gmail.com', '', 1, '2025-04-25 16:55:27', NULL),
	(20, 2, '', '254724802834', 2, '2025-04-26 14:45:11', NULL);
...
-- Dumping data for table rt_oris.country_code: ~228 rows (approximately)
...
INSERT INTO `customer_types` (`id`, `name`, `created_at`, `updated_at`, `company_id`) VALUES
	(1, 'Premium ', '2025-05-19 20:43:40', '2025-05-19 20:43:41', 2),
	(2, 'Regular', '2025-05-22 11:04:52', '2025-05-22 11:04:53', 2);
...
INSERT INTO `emails` (`id`, `email`, `name`, `dept_id`, `priority_id`, `company_id`, `help_topic`, `username`, `password`, `fetching_host`, `fetching_port`, `fetching_protocol`, `fetching_encryption`, `mailbox_protocol`, `imap_config`, `folder`, `sending_host`, `sending_port`, `sending_protocol`, `sending_encryption`, `smtp_validate`, `smtp_authentication`, `internal_notes`, `auto_response`, `fetching_status`, `move_to_folder`, `delete_email`, `do_nothing`, `sending_status`, `authentication`, `header_spoofing`, `created_at`, `updated_at`, `active`) VALUES
	(1, 'info@nezasoft.net', 'Nezasoft Email', 1, 3, 2, NULL, 'info@nezasoft.net', '#info2016', 'saver.vivawebhost.com', '993', 'imap', 'tls', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, 1),
	...
	(4, 'demo@nezasoft.net', 'Support Email', 3, 1, 2, NULL, 'demo@nezasoft.net', '#demo2016', 'saver.vivawebhost.com', '466', 'imap', 'ssl', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-05-19 16:37:03', '2025-05-19 16:37:03', 0);
...
INSERT INTO `event_types` (`id`, `name`, `created_at`, `updated_at`) VALUES
	(1, 'Ticket Created', '2025-05-22 11:24:09', '2025-05-22 11:24:11'),
	(2, 'First Response Sent', '2025-05-22 11:24:22', '2025-05-22 11:24:23'),
	(3, 'Ticket Assigned', '2025-05-22 11:24:34', '2025-05-22 11:24:35'),
	(4, 'Status Changed', '2025-05-22 11:24:44', '2025-05-22 11:24:45'),
	(5, 'Customer Responded', '2025-05-22 11:24:53', '2025-05-22 11:24:54'),
	(6, 'Ticket Resolved', '2025-05-22 11:25:40', '2025-05-22 11:25:53'),
	(7, 'Ticket Closed', '2025-05-22 11:25:51', '2025-05-22 11:25:52'),
	(8, 'SLA Breach Detected', '2025-05-22 11:26:04', '2025-05-22 11:26:05'),
	(9, 'Escalation Triggered', '2025-05-22 11:26:17', '2025-05-22 11:26:18');
...
-- Dumping data for table rt_oris.notifications: ~2 rows (approximately)
DELETE FROM `notifications`;
/*!40000 ALTER TABLE `notifications` DISABLE KEYS */;
INSERT INTO `notifications` (`id`, `user_id`, `type_id`, `created_at`, `updated_at`, `company_id`, `status`) VALUES
	(1, 1, 3, '2025-05-24 05:16:10', '2025-05-24 05:16:10', NULL, 0),
	(2, 1, 3, '2025-05-31 07:57:48', '2025-05-31 07:57:48', NULL, 0),
	(3, 2, 5, '2025-06-01 15:45:27', '2025-06-01 15:45:27', NULL, 0);
...
INSERT INTO `notification_types` (`id`, `message`, `type`, `icon_class`, `created_at`, `updated_at`) VALUES
	...
	(4, 'Ticket has been closed', 'closed', 'fa fa-envelope', '2025-05-31 12:48:40', '2025-05-31 12:48:40'),
	(5, 'Ticket has been resolved', 'resolved', 'fa fa-envelope', '2025-05-31 12:49:53', '2025-05-31 12:49:53');
...
-- Dumping data for table rt_oris.sessions: ~9 rows (approximately)
...
-- Dumping data for table rt_oris.sla_events: ~6 rows (approximately)
...
INSERT INTO `sla_events` (`id`, `ticket_id`, `event_type_id`, `status_id`, `due_date`, `company_id`, `met_at`, `created_at`, `updated_at`, `sla_policy_id`) VALUES
	(1, 1, 1, 1, '2025-05-23 14:15:49', 2, NULL, '2025-05-23 12:15:49', '2025-05-23 12:15:49', 1),
	(2, 1, 2, 2, '2025-05-23 12:18:20', 2, NULL, '2025-05-23 12:18:20', '2025-05-23 12:18:20', 1),
	(3, 2, 1, 1, '2025-05-24 07:16:10', 2, NULL, '2025-05-24 05:16:10', '2025-05-24 05:16:10', 3),
	(4, 2, 2, 2, '2025-05-24 05:18:59', 2, NULL, '2025-05-24 05:18:59', '2025-05-24 05:18:59', 3),
	(5, 3, 1, 1, '2025-05-31 09:57:48', 2, NULL, '2025-05-31 07:57:48', '2025-05-31 07:57:48', 2),
	(6, 1, 6, 2, '2025-06-01 15:45:27', 2, NULL, '2025-06-01 15:45:27', '2025-06-01 15:45:27', 2);
...
INSERT INTO `sla_policies` (`id`, `name`, `response_time_min`, `resolve_time_min`, `is_default`, `company_id`, `created_at`, `updated_at`) VALUES
	(1, 'Gold Customer SLA', 120, 120, 1, 2, '2025-05-19 17:01:54', '2025-05-19 17:10:06'),
	(2, 'Bronze Customer SLA', 120, 120, 0, 2, '2025-05-19 17:11:17', '2025-05-19 17:11:17'),
	(3, 'Silver Customer SLA', 120, 120, 0, 2, '2025-05-19 17:11:28', '2025-05-19 17:11:28'),
	(4, 'Test Customer SLA', 120, 120, 0, 2, '2025-05-19 17:14:25', '2025-05-19 17:14:25');
...
INSERT INTO `sla_rules` (`id`, `sla_policy_id`, `customer_type_id`, `priority_id`, `channel_id`, `created_at`, `updated_at`, `company_id`) VALUES
	(1, 1, 1, 1, 1, '2025-05-23 09:02:05', '2025-05-23 09:02:05', 2),
	(2, 1, 1, 1, 2, '2025-05-23 09:02:10', '2025-05-23 09:02:10', 2),
	(3, 1, 1, 1, 3, '2025-05-23 09:02:15', '2025-05-23 09:02:15', 2),
	(4, 2, 1, 2, 1, '2025-05-23 09:03:39', '2025-05-23 09:03:39', 2),
	(5, 2, 1, 2, 2, '2025-05-23 09:03:47', '2025-05-23 09:03:47', 2),
	(6, 2, 1, 2, 3, '2025-05-23 09:03:51', '2025-05-23 09:03:51', 2),
	(7, 2, 2, 1, 1, '2025-05-23 09:04:26', '2025-05-23 09:04:26', 2),
	(8, 2, 2, 1, 2, '2025-05-23 09:04:31', '2025-05-23 09:04:31', 2),
	(9, 2, 2, 1, 3, '2025-05-23 09:04:34', '2025-05-23 09:04:34', 2),
	(10, 3, 2, 2, 1, '2025-05-23 09:05:39', '2025-05-23 09:05:39', 2),
	(11, 3, 2, 2, 2, '2025-05-23 09:05:45', '2025-05-23 09:05:45', 2),
	(12, 3, 2, 2, 3, '2025-05-23 09:05:49', '2025-05-23 09:05:49', 2);
...
INSERT INTO `statuses` (`id`, `name`, `created_at`, `updated_at`) VALUES
	...
	(5, 'Closed', '2025-05-31 12:26:26', '2025-05-31 12:26:27');
...
INSERT INTO `templates` (`id`, `name`, `variable`, `type`, `subject`, `message`, `description`, `set_id`, `created_at`, `updated_at`) VALUES
	...
	(6, 'This template is for sending notice to client on new ticket created by agent in name of client', '0', 6, 'New Ticket Created', '<div> {{content}}<br /><br /> {{agent_sign}}<br /><br />You can check the status of or update this ticket online at: {{system_link}}</div>', '', 1, '2016-12-13 06:19:51', '2016-12-13 06:19:51'),
	...
	(9, 'This template is for sending notice to client when a reply made to his/her ticket', '0', 9, 'Reply on Ticket', '<span></span><div><span></span><p> {{content}}<br /></p><p> {{agent_sign}}</p><p><b>Ticket Details</b></p><p><b>Ticket ID:</b> {{ticket_no}}</p></div>', '', 1, '2016-12-13 06:19:51', '2016-12-13 06:19:51'),
	...
	(12, 'This template is for sending notice to team when ticket is assigned to team', '1', 12, '', '<div>Hello {!!$ticket_agent_name!!},<br /><br /><b>Ticket No:</b> {!!$ticket_number!!}<br />Has been assigned to your team : {!!$team!!} by {!!$ticket_assigner!!}Ã‚Â <br /><br />Thank You<br />Kind Regards,<br />{!!$system_from!!}</div>', '', 1, '2016-12-13 06:19:52', '2016-12-13 06:19:52'),
	...
	(15, 'This template is for sending notice to client when ticket status is changed to resolved', '0', 15, 'Ticket Resolved', '<div>Hello,<br /><br />This message is regarding your ticket ID {{ticket_no}}. We are changing the status of this ticket to "Resolved" as the issue appears to be resolved.<br /><br />Thank you<br />Kind regards,<br /> {{department}}</div>', ' ', 1, '2025-06-01 15:34:12', '2025-06-01 15:34:15');
...
INSERT INTO `template_types` (`id`, `name`, `created_at`, `updated_at`) VALUES
	...
	(15, 'resolve-ticket', '2025-06-01 15:32:59', '2025-06-01 15:32:57');
...
-- Dumping data for table rt_oris.tickets: ~2 rows (approximately)
DELETE FROM `tickets`;
/*!40000 ALTER TABLE `tickets` DISABLE KEYS */;
INSERT INTO `tickets` (`id`, `ticket_no`, `customer_id`, `priority_id`, `channel_id`, `ticket_type_id`, `subject`, `status_id`, `company_id`, `dept_id`, `description`, `first_response_at`, `resolved_at`, `created_at`, `updated_at`, `sla_policy_id`, `sla_duration`, `escalated_at`, `phone`, `email`) VALUES
	(1, '100000001', 1, 1, 2, 1, '[This is the initial test for the mail channel] - 100000001', 3, 2, 3, 'Dear support i have been having issues with my internet connection for the last 3 days. Kindly resolve.', '2025-05-23 12:18:20', NULL, '2025-05-23 12:15:49', '2025-06-01 15:52:56', NULL, NULL, NULL, NULL, 'walter.omedo@gmail.com'),
	(2, '100000002', 0, 2, 3, 2, '[Good Morning, I am having a problem with my internet connection. Please look into it] - 100000002', 3, 2, 1, 'Good Morning, I am having a problem with my internet connection. Please look into it', '2025-05-24 05:18:59', NULL, '2025-05-24 05:16:10', '2025-05-24 05:18:59', NULL, NULL, NULL, NULL, NULL),
	(3, '100000003', 1, 1, 1, 2, '[Test Web Portal Ticket] - 100000003', 1, 2, 1, 'Test web Portal Ticket Description', NULL, NULL, '2025-05-31 07:57:48', '2025-05-31 07:57:48', NULL, NULL, NULL, NULL, NULL);
...
-- Dumping data for table rt_oris.ticket_escalations: ~0 rows (approximately)
...
-- Dumping data for table rt_oris.ticket_replies: ~6 rows (approximately)
...
INSERT INTO `ticket_replies` (`id`, `ticket_id`, `user_id`, `reply_message`, `reply_at`, `created_at`, `updated_at`) VALUES
	(1, 1, 0, 'Hello thank for your email. we have looked into your issue. Kindly reboot your router and tell us if your experience has improved.', '2025-05-23 12:18:20', '2025-05-23 12:18:20', '2025-05-23 12:18:20'),
	(2, 2, 1, 'Dear esteemed customer. Thank you for your message. Our team is working  to resolve the issue', '2025-05-24 05:18:59', '2025-05-24 05:18:59', '2025-05-24 05:18:59'),
	(3, 1, 1, 'This is a ticket reply message', '2025-05-31 16:46:00', '2025-05-31 16:46:00', '2025-05-31 16:46:00'),
	(4, 1, 1, 'This is a ticket reply message', '2025-05-31 16:54:16', '2025-05-31 16:54:16', '2025-05-31 16:54:16'),
	(5, 1, 1, 'This is a ticket reply message', '2025-06-01 08:13:38', '2025-06-01 08:13:38', '2025-06-01 08:13:38'),
	(6, 1, 1, 'This is a ticket reply message', '2025-06-01 15:52:56', '2025-06-01 15:52:56', '2025-06-01 15:52:56');
...
/*!40000 ALTER TABLE `twillios` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `twillios` ENABLE KEYS */;
...
/*!40000 ALTER TABLE `whats_apps` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `whats_apps` ENABLE KEYS */;
