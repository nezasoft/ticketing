...
const EditTemplateModal: React.FC<Props> = ({ isOpen, onClose, onUpdated,template }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append("item_id", template.id.toString()); // important: tell API which user to update
      ...
      const response = await editTemplate(formData);
      if (response.success) {
