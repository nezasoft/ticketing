...
const SLAEventsList: React.FC<SLAEventsListProps> = ({sla_events}) => 
{
    ...
    const filteredSLAEvents = sla_events.filter((sla_event)=>
    {
        ...
        String(sla_event.ticket_no ?? "").toLowerCase().includes(term) ||
    ...
    <div className="p-4">
      ...
      <div className="flex flex-wrap gap-2 items-center justify-between mb-4">
        <div className="flex">
          <div className="relative w-full md:w-64">
            ...
            <input
              type="text"
              placeholder="Search Ticket No, Policy Name, Event Type"
              value={searchTerm}
      ...
      <Pagination
        ...
        totalItems={filteredSLAEvents.length}
